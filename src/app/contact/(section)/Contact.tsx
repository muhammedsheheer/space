  ...
  return (
    ...
    >
      <div className="flex h-full w-full max-w-[1300px] flex-col gap-[2.5rem] px-0 py-12 pl-0 md:px-2 md:py-24">
          ...
          <div className="flex w-full flex-col gap-8 bg-[#000] px-6 lg:w-1/2 lg:px-28">
            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-4">
                  <Link href={"https://g.co/kgs/CQkGzL4"} target="_blank">
                    <p className="text-[#9C9E9F]">
                      382 Aigburth Rd, Aigburth, <br /> Liverpool L19 3QD,
                      United Kingdom
                    </p>
                  </Link>
                  <Link href={"https://g.co/kgs/CQkGzL4"} target="_blank">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <Link href="tel:+441514942979" className="text-[#9C9E9F]">
                    +44 151 494 2979
                  </Link>
                </div>
              </div>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="h-full">
                  ...
                  <div className="flex w-full flex-col pt-7 lg:flex-row">
                    <Button
                      className="font-bai w-full rounded-2xl bg-[#D3A641] py-6 text-white placeholder:text-[#fff] hover:bg-[#fcce62]"
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2262.8849935287194!2d-2.9246546!3d53.3668994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487b206fc7dbff61%3A0xbe93c88d0265036b!2sSpace%20Coffee%20Bar%20And%20Grill!5e1!3m2!1sen!2sin!4v1743662998786!5m2!1sen!2sin"
          style={{ border: 0 }}
          allowFullScreen
          loading="lazy"
