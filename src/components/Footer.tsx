      ...
      <div className="flex flex-col gap-4 pt-12 md:gap-8 lg:pt-24">
        ...
        <div className="flex flex-col gap-8 md:flex-row md:justify-between md:gap-14 md:px-32">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:gap-36">
            <div className="flex flex-col items-start gap-4 md:gap-8">
              ...
              <div className="flex flex-col items-start gap-2 md:pt-4">
                <div className="flex flex-col items-start">
                  <span className="flex flex-col text-left font-open_sans text-base font-[600] uppercase tracking-[1px] text-white md:text-start">
                    Contact
                  </span>
                  <br />
                  <span>
                    <Link
                      className="flex flex-col text-left font-open_sans text-base font-[400] uppercase tracking-[1px] text-white md:text-start"
                      target="_blank"
                      href={"https://g.co/kgs/CQkGzL4"}
                    >
                      382 Aigburth Rd, Aigburth,
                  ...
                  <span>
                    <Link
                      className="font-open_sans text-base font-[400] lowercase tracking-[1px] text-white"
                      href={"mailto:umutsahindal@hotmail.com"}
                    >
                      umutsahindal@hotmail.com
                    </Link>
            ...
            <div className="flex flex-col items-end justify-center gap-4 md:mt-24 md:items-start md:gap-6">
              <Link
                href={"/"}
                className="font-open_sans text-base font-[400] uppercase tracking-[2.4px] text-white"
              >
          ...
          {/* sub second  div */}
          <div className="flex w-full flex-col items-end gap-2 md:w-[400px] md:items-start md:pt-16">
            <h6 className="font-open_sans text-base font-[600] uppercase tracking-[2.2px] text-white md:pb-4">
              Opening Hours
            </h6>
            <div className="flex flex-col items-end gap-4 md:items-start md:gap-6">
              <div className="h-full w-full border-b-[1px] border-b-[#D9D9D9]" />

              <div className="flex w-full flex-row justify-end gap-4 md:w-[400px] md:justify-between">
                <span className="font-open_sans text-base font-[400] uppercase tracking-[1.96px] text-white">
                  Monday
                </span>
                <span className="font-open_sans text-base font-[400] uppercase tracking-[1.96px] text-white">
